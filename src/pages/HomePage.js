...
const HomePage = () => {
  ...
  return (
    <div className="w-full">
      <div className="bg-gray-100 pt-16 pb-20"> {/* Increase padding top (pt) here */}
        <div className="container mx-auto flex flex-col items-center">
          ...
          <div className="flex justify-center items-center pb-16">
            <button onClick={() => setShowModal(true)} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 lg:text-xl lg:font-bold  rounded text-white px-2 sm:px-5 border border-indigo-700 py-1 sm:py-2 text-sm">Get Started</button>
            <button className="  ml-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-transparent transition duration-150 ease-in-out hover:border-indigo-600 lg:text-xl lg:font-bold  hover:text-indigo-600 rounded border border-indigo-700 text-indigo-700 px-2 sm:px-5 py-1 sm:py-2 text-sm">Live Demo</button>
          </div>
        </div>
      </div>
